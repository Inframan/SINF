...
namespace FirstREST.Lib_Primavera
{
    public class PriIntegration
    {
        ...
        public static List<Model.DocVenda> Encomenda_Get(string clientID)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                string st = "SELECT id, Entidade, Data, NumDoc, TotalMerc, Serie From CabecDoc where  Entidade='" + clientID + "'";
        ...
        public static List<Model.DocVenda> Encomenda_Get()
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                string st = "SELECT id, Entidade, Data, NumDoc, TotalMerc, Serie From CabecDoc";
                objListCab = PriEngine.Engine.Consulta(st);
                while (!objListCab.NoFim())
                {
                    dv = new Model.DocVenda();
